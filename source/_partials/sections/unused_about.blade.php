<section class="bg-gray-100 py-12 px-4">
      ...
      <section class="text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8">
          <div class="p-4 shadow-lg rounded-lg bg-amber-100 hover:bg-amber-200 transition-colors">
      ...
      <section class="bg-amber-500 text-white text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
          <div class="p-4 shadow-lg rounded-lg bg-amber-600 hover:bg-amber-500 transition-colors">
